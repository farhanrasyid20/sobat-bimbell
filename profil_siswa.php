...
// Query untuk mengambil data siswa berdasarkan nama (username)
$query = "SELECT * FROM siswa WHERE id = '$username'";
            ...
            <div class="profil">
                <div class="profil-info">
                    ...
                    <div class="col-md-10 mt-3 mx-auto">
                        ...
                        <label>Nama</label>
                        <input type="text" name="nama" value="<?php echo $siswa['nama']; ?>" readonly>

                        <label>Tempat</label>
                        <input type="text" name="tempat" value="<?php echo $siswa['tempat']; ?>" readonly>

                        <label>Tanggal Lahir</label>
                        <input type="text" name="ttl" value="<?php echo $siswa['ttl']; ?>" readonly>

                        <label>Jenis Kelamin</label>
                        <input type="text" name="jenis kelamin" value="<?php echo $siswa['jk']; ?>" readonly>

                        <label>Sekolah</label>
                        <input type="text" name="sekolah" value="<?php echo $siswa['sekolah']; ?>" readonly>

                        <label>Email</label>
                        <input type="text" name="email" value="<?php echo $siswa['email']; ?>" readonly>
                    </div>
                </div>
            </div>
        </div>
