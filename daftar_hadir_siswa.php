...
// Query untuk mengambil daftar kehadiran siswa berdasarkan sesi ID
$id_siswa = $_SESSION['id'];
$query = "
    SELECT k.mapel, k.minggu, k.status 
    FROM kehadiran k
...
while ($data = mysqli_fetch_assoc($result)) {
    $kehadiran[$data['mapel']][$data['minggu']] = $data['status'];
}
?>
        ...
        <div class="content">
            ...
            <div class="table-container">
                ...
                <table>
                    ...
                    <?php foreach ($kehadiran as $mapel => $minggu_data) { ?>
                        <tr>
