            ...
            <div class="table-container">
                ...
                <div class="card-container">
                    <div class="card">
                        ...
                        <button onclick="window.location.href='nilai_indo.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT
                        </button>
                    </div>
                    <div class="card">
                        <h2>BAHASA INGGRIS</h2>
                        <button onclick="window.location.href='nilai_inggris.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT
                        </button>
                    </div>
                    <div class="card">
                        <h2>MATEMATIKA</h2>
                        <button onclick="window.location.href='nilai_mtk.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT
                        </button>
                    </div>
                </div>
