...
<head>
    ...
    <title>Input Guru Bahasa Indonesia</title>
...
<body>
    <div class="d-flex">
        ...
        <div class="content">
            ...
            <h3>INPUT GURU BAHASA INDONESIA</h3>
            <div class="col-md-3 mx-auto text-center">
                <table class="table table-striped table-bordered mt-4">
                    ...
                    <tbody>
                        <?php
                        include 'koneksi.php';
                        $query = mysqli_query($koneksi, "SELECT * FROM mapel WHERE mapel = 'Bahasa Indonesia'");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hapus_gm_indo.php?id=<?php echo $data['nama_guru']; ?>" class="btn btn-danger btn-sm">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="simpan_gm_indo.php" method="POST">
                                    <div class="mb-3">
