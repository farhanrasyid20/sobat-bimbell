            ...
            <div class="table-container">
                ...
                <div class="card-container">
                    <div class="card">
                        ...
                        <button onclick="window.location.href='otoritas_gm_indo.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT GURU
                        </button>
                    </div>
                    <div class="card">
                        <h2>BAHASA INGGRIS</h2>
                        <button onclick="window.location.href='otoritas_gm_inggris.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT GURU
                        </button>
                    </div>
                    <div class="card">
                        <h2>MATEMATIKA</h2>
                        <button onclick="window.location.href='otoritas_gm_mtk.php'">
                            <i class="fas fa-plus-circle me-2"></i>INPUT GURU
                        </button>
                    </div>
                </div>
