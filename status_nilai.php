...
// Query untuk mengambil data nilai berdasarkan mata pelajaran dan minggu
$query = "SELECT s.nama, k.nilai  
          FROM nilai k
                        ...
                        <table class="table table-striped table-bordered mt-4 text-center">
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>" . htmlspecialchars($data['nilai']) . "</td>";  // Display the correct grade (nilai)
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
